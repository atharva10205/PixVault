...
const Explore = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex items-center justify-center font-sans font-semibold text-[37px] mb-[40px]">Stay Inspired</div>
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="grid grid-cols-2 gap-4 m-6" >
          ...
          <div className="relative w-[450px] h-[450px] m-2 cursor-pointer rounded-lg shadow-lg">
            <img src="https://i.pinimg.com/474x/13/8f/06/138f0675237eec3563d1475ec63f7262.jpg"
          ...
          <div className="relative w-[450px] h-[450px] m-2 cursor-pointer rounded-lg shadow-lg">
            <img src="https://i.pinimg.com/736x/e1/22/34/e122343ac7ddb125851689e1fb05cc4a.jpg" 
      ...
      <div className="mt-[40px]">
        <div className="flex items-center justify-center font-sans font-semibold text-[20px]">That's all for today!</div>
        <div className="flex items-center justify-center font-sans font-semibold text-[28px]">Come back tomorrow for more inspiration</div>
      </div>

      <div className="flex items-center justify-center pb-40">
        <button 
        onClick={handelhomebuttonclick}
        className="bg-red-600 px-8 py-4 rounded-[30px] font-semibold ">Home</button>
      </div>
